...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "MarketSim — Market Simulation & Strategy Testing Platform" },
      { name: "twitter:title", content: "MarketSim — Market Simulation & Strategy Testing Platform" },
      { property: "og:description", content: "An ML-powered agent-based market simulation and strategy testing platform — Acharya Institute of Technology, Major Project 2025-26." },
      { name: "twitter:description", content: "An ML-powered agent-based market simulation and strategy testing platform — Acharya Institute of Technology, Major Project 2025-26." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/14a3392d-993b-4532-81c7-947e0ef7e589/id-preview-3da600c2--158303c1-a59d-40e1-94da-704d6513b924.lovable.app-1779016708021.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/14a3392d-993b-4532-81c7-947e0ef7e589/id-preview-3da600c2--158303c1-a59d-40e1-94da-704d6513b924.lovable.app-1779016708021.png" },
